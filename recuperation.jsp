...
<head>
	...
	<link rel="shortcut icon" href="assets/images/logo_eau.jpegs">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="evauation.jsp">Evacuation</a></li>
		...
		<div class="row">
			...
			<aside class="col-md-4 sidebar sidebar-right">
				...
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Lorem ipsum dolor sit</h4>
						<p><img src="assets/images/canal.jpg" alt=""></p>
					</div>
				</div>
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Lorem ipsum dolor sit</h4>
						<p><img src="assets/images/zone-de-captage-1080x900.png" alt=""></p>
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<a href="recuperation.jsp">Evacuation</a> |
